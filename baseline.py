...
Reads: HF_TOKEN, API_BASE_URL, MODEL_NAME from environment.
...
def main():
    ...
    parser.add_argument("--model", default=os.getenv("MODEL_NAME", "gpt-4o"))
    parser.add_argument("--seed",  type=int, default=42)
    args = parser.parse_args()

    # ✅ FIXED: read HF_TOKEN as required by competition rules
